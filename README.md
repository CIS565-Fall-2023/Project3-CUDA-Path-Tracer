...
V: Material shading (diffuse & perfectly specular)
P: Path termination with stream compaction
P: Material sorting
P: First bounce ray caching

V: Extra material shading: refraction, glass, plastic, lambertian BTDF
V: Stochastic sampled anti-aliasing
V: Motion blur (camera ray jitter about some axis)
V: Runtime object motion (continuous transformation update throughout time)
V: Physically based depth of field (thin-lens camera)
V: glTF & GLB mesh loading (P: with bounding box culling)
V: OBJ mesh loading (P: with bounding box culling)
P: Bounding volume hierarchy (with both midpoint split and attempt of SAH, no sure if working properly)
...
<p align="left">
  <img src="/img/bsdf.png" width="100"/>
  <img src="/img/backward_tracing.PNG" width="100"/>
  <img src="/img/real_world_light.PNG" width="100"/>
</p>
